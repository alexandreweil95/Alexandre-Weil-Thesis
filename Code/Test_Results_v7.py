# - Do a separate test script for the testing script and have AUC over several bags (need a loop in it). Look at sk.learn for AUC

print("Let's do visualisation on a GATED ResNet18 attention-based model with max-pooling, bag_loss)!")
print("This is Test_Results_v6")
...
# from google.colab import output # Only to be used in Colab
import tensorflow as tf
import tensorflow.keras.backend as tfback # To use on Cluster
# import keras.backend.tensorflow_backend as tfback # To use on Colab
