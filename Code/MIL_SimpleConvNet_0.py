print("Let's train a very simple_conv_net with Gated attention and bag_loss, as a baseline model. Patience=2 for 50 epochs")
print("This is MIL_SimpleConvNet")
...
## Not 100% sure that this is the right piece of code to use
try:
